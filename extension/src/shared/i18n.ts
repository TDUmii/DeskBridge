...
const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    contextAccess: "Workspace context", contextReadOnly: "Selective read-only access", contextGuard: "Secrets, ignored paths, writes, and commands are blocked",
  ...
  vi: {
    ...
    contextAccess: "Ngữ cảnh workspace", contextReadOnly: "Chỉ đọc có chọn lọc", contextGuard: "Chặn tệp nhạy cảm, đường dẫn bỏ qua, thao tác ghi và lệnh",
