...
public sealed class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["AgentIntro"] = "Create from a request, use selective read-only workspace context, or improve one selected file. DeskBridge stays on ChatGPT Web and checks downloads locally.",
        ["ChooseStart"] = "Choose how to start", ["ChooseStartHelp"] = "Create from an idea, use bounded read-only workspace context, or improve one selected file.",
        ["CreateNew"] = "Create new", ["CreateNewHelp"] = "Request only. No workspace uploads.",
        ["WorkspaceContext"] = "Use workspace context", ["WorkspaceContextHelp"] = "Read-only, selective, and secret-blocked.",
        ["ReadOnlyContext"] = "Protected workspace context", ["ReadOnlyContextHelp"] = "ChatGPT may request only small, necessary text ranges. Sensitive paths, build output, and entries in .deskbridgeignore are always blocked.",
    ...
    private static readonly IReadOnlyDictionary<string, string> VietnameseResources = new Dictionary<string, string>
    {
        ...
        ["AgentIntro"] = "Tạo từ yêu cầu, dùng ngữ cảnh workspace chỉ đọc có chọn lọc hoặc cải thiện một tệp. DeskBridge luôn dùng ChatGPT Web và kiểm tra tệp tải xuống trên máy.",
        ["ChooseStart"] = "Chọn cách bắt đầu", ["ChooseStartHelp"] = "Tạo từ ý tưởng, dùng ngữ cảnh workspace chỉ đọc hoặc cải thiện một tệp được chọn.",
        ["CreateNew"] = "Tạo mới", ["CreateNewHelp"] = "Chỉ gửi yêu cầu. Không tải tệp trong không gian làm việc lên.",
        ["WorkspaceContext"] = "Dùng ngữ cảnh workspace", ["WorkspaceContextHelp"] = "Chỉ đọc, có chọn lọc và chặn tệp nhạy cảm.",
        ["ReadOnlyContext"] = "Ngữ cảnh workspace được bảo vệ", ["ReadOnlyContextHelp"] = "ChatGPT chỉ có thể yêu cầu các đoạn văn bản nhỏ cần thiết. Đường dẫn nhạy cảm, thư mục build và mục trong .deskbridgeignore luôn được chặn.",
